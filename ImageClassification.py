...
main = tkinter.Tk()
main.title("Real-Time Object Detection Using CNN-Based Image Classification") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Real-Time Object Detection Using CNN-Based Image Classification', justify=LEFT)
